    ...
    <div className="fixed bottom-0 left-0 right-0 glass-card border-t border-white/10 z-50 animate-pulse">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 bg-white/10 rounded-[10px]" />
...
export function DiscoverySkeleton() {
  return (
    <div className="glass-card p-6 rounded-[10px] animate-pulse space-y-4">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 bg-white/10 rounded-[10px]" />
        <div className="flex-1 space-y-2">
      ...
      <div className="space-y-2">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="flex items-center gap-3 p-2">
            ...
            <div className="w-12 h-12 bg-white/5 rounded-[10px]" />
